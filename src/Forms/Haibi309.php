...
class Haibi309 extends SubmittableForm
{
    ...
    protected static function submitForm(KishukushaReportSupporter $supporter): void
    {
        ...
        $driveFileName = "309_{$supporter->storage['userName']}_{$itemName}.jpg";
        $answers['保管品の画像'] = $supporter->saveToDrive($imageFileName, $driveFileName, $supporter->config['generalImageFolderId'], '309私物配備届');
